...
def main():
    ...
    parser.add_argument('-m', '--model', default='experiment/'+filename+'/dqn.pth')
    parser.add_argument('--logdir', default='log/'+filename)
    # train
    ...
    parser.add_argument('--eps_decay', default=0.99998, type=float)
    ...
    os.makedirs('experiment/'+filename, exist_ok=True)
